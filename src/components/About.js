import {Circle, Box, Button, Flex, Text, Image } from '@chakra-ui/react'
...
const About = () => {
    return (
        <Box>
            <Box boxSize="xs" style={styles.img} mt={{sm: '300px', md: '200px', lg:'150px', base: '100px'}}>
